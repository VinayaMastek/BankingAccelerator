...
public class LoanAccountOpened {
	String CustomerId;
	...
	public LoanAccountOpened() {
		super();
	}
	
	public LoanAccountOpened(String customerId, String accountNumber,
			...
			String accountHolder3Id, String accountHolder4Id, String location) {
		super();
