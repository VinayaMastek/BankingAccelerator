...
public class ChargeWithdrawal {
	String	AccountNumber;
	double	Amount;
	String	TransactionDt;
	String	TransactionId;
	String	TransactionType; // CHGS
	double	BalAmount;
	String	CustomerId;
	String	Location;
	String Reference;
	public ChargeWithdrawal(String accountNumber, double amount,
	...
	public String toString() {
		return String
				.format("ChargeWithdrawal [AccountNumber=%s, Amount=%s, TransactionDt=%s, TransactionId=%s, TransactionType=%s, BalAmount=%s, CustomerId=%s, Location=%s, Reference=%s]",
