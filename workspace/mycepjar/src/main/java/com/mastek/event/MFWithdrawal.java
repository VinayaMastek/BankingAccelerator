...
public class MFWithdrawal {
	String	AccountNumber;
	double	Amount;
	String	TransactionDt;
	String	TransactionId;
	String	TransactionType; // MF
	double	BalAmount;
	String	CustomerId;
	String	Location;
	String Reference;
	public MFWithdrawal(String accountNumber, double amount,
	...
	public String toString() {
		return String
				.format("MFWithdrawal [AccountNumber=%s, Amount=%s, TransactionDt=%s, TransactionId=%s, TransactionType=%s, BalAmount=%s, CustomerId=%s, Location=%s, Reference=%s]",
