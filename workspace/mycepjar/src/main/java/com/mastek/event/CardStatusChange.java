...
public class CardStatusChange {
	...
	public CardStatusChange() {
		super();
	}


	public CardStatusChange(String customerId, String cardNumber,
	...
	public String toString() {
		return String
				.format("CardStatusChange [CustomerId=%s, CardNumber=%s, ChangeDt=%s, Reason=%s, CardType=%s, CardHolderId=%s, CardStatus=%s,Location = %s]",
