...
public class BillWithdrawal {
	...
	String	Location;
	String Reference;
	public BillWithdrawal(String accountNumber, double amount,
	...
	public String toString() {
		return String
				.format("BillWithdrawal [AccountNumber=%s, Amount=%s, TransactionDt=%s, TransactionId=%s, TransactionType=%s, BalAmount=%s, CustomerId=%s, Location=%s, Reference=%s]",
