...
public class CreditCardStatusChange {
	...
	public CreditCardStatusChange() {
		super();
	}


	public CreditCardStatusChange(String customerId, String cardNumber,
	...
	public String toString() {
		return String
				.format("CreditCardStatusChange [CustomerId=%s, CardNumber=%s, ChangeDt=%s, Reason=%s, CardType=%s, CardHolderId=%s, CardStatus=%s,Location = %s]",
