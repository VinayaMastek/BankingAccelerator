...
public class DCWithdrawal {
	String	AccountNumber;
	double	Amount;
	String	TransactionDt;
	String	TransactionId;
	String	TransactionType; // DC
	double	BalAmount;
	String	CustomerId;
	String	Location;
	String Reference;
	public DCWithdrawal(String accountNumber, double amount,
	...
	public String toString() {
		return String
				.format("DCWithdrawal [AccountNumber=%s, Amount=%s, TransactionDt=%s, TransactionId=%s, TransactionType=%s, BalAmount=%s, CustomerId=%s, Location=%s, Reference=%s]",
