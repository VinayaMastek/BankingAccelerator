...
public class WithdrawalsMade {
	...
	public WithdrawalsMade(){
		super();
	}
	
	public WithdrawalsMade(String accountNumber, double amount,
	...
	public String toString() {
		return String
				.format("WithdrawalsMade [AccountNumber=%s, Amount=%s, TransactionDt=%s, TransactionId=%s, TransactionType=%s, BalAmount=%s, CustomerId=%s, Location=%s, Reference=%s]",
