...
public class CurrentAccountClosed {
	...
	public CurrentAccountClosed(String customerId, String accountNumber,
	...
	public String toString() {
		return String
				.format("CurrentAccountClosed [CustomerId=%s, AccountNumber=%s, ClosingDt=%s, Reason=%s, Location=%s, AccountType=%s]",
